...
/* ── Main ── */
const SoldDonatedPage = ({ user, onNavigate, onLogout, onNavigateBack }) => {
  ...
  return (
    <DashboardLayout role={user?.role||"user"} user={user} activeTab="sold-donated"
      onTabChange={(tab) => onNavigate(tab)} onLogout={onLogout} onNavigate={onNavigate} onNavigateBack={onNavigateBack}>
